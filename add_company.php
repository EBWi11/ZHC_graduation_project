...
$sql ="insert into Company(Cname,Cadd,Ctel,Cword,Ctime)  values('$Cname','$Cadd','$Ctel','$Cword','$time');";
mysqli_query($db,$sql);
}
?>
<!DOCTYPE html>
...
<head>
	<title>高耗能企业电力能效数据上报与管理系统－添加企业</title>
	<meta charset="utf-8" />
...
<body>
    ...
    <form name="add_company" method="post"  onsubmit="return doCheck();" action="">
      <table width="670" border="1" align="center" ceellpadding="30"style="margin-top:50px">
      <tr>
        <td>公司名称:</td>
        <td><input style="width:605px;" name="Cname" type="text" id="Cname"></td>
      </tr>
      <tr>
        <td>公司地址:</td>
        <td><input style="width:605px;" name="Cadd" type="text" id="Cadd"></td>
      </tr>
      <tr>
        <td>公司电话:</td>
        <td><input style="width:605px;" name="Ctel" type="text" id="Ctel"></td>
      </tr>
      <tr>
        <td>公司简介:</td>
        <td><textarea rows="10" cols="83" name="Cword" id="Cword"></textarea></td>
      </tr>
      <tr>
