...
<body>
	...
	function modify(id)
	{
		self.location='modify_company.php?id='+id;
	}
	</script>
<?php
...
while($row = mysqli_fetch_array($result))
	...
	//echo "<td>".'<button name="'. $row['Cid'] .'"  onclick="modify(this.name)">修改信息</button>'." </td>";
	echo "<td>".'<button id="'. $row['Cid'] .'"  onclick="del(this.id)">删除信息</button>'." </td>";
	echo "</tr>";
	}
echo "</table>";
mysqli_close($con);
